...
For one-off use cases, you can use my web utilty [Plot Extractor](https://tools.dilawars.me/tool/plot-extractor).
...
1. https://tools.dilawars.me/tool/plot-extractor is web-utility to extract data manually.
